Public Class Form1
    ...
    Public Shared dlUpVer As String =
        "0"
    Public Shared dlDlcUpVer As String =
        "0"
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ComboBox1.Items.Add("justdlc")
        ComboBox2.Items.Add("0")
        ComboBox2.Items.Add("1")
        ComboBox2.Items.Add("65536")
        ComboBox2.Items.Add("131072")
        ComboBox2.Items.Add("196608")
        ComboBox2.Items.Add("262144")
        ComboBox2.Items.Add("327680")
        ComboBox2.Items.Add("393216")
        ComboBox2.Items.Add("458752")
        ComboBox2.Items.Add("524288")
        ComboBox2.Items.Add("589824")
        ComboBox2.Items.Add("655360")
        ComboBox2.Items.Add("720896")
        ComboBox2.Items.Add("786432")
        ComboBox2.Items.Add("854968")
        ComboBox2.Items.Add("917504")
        ComboBox2.Items.Add("983040")
        ComboBox2.Items.Add("1048576")
    End Sub
    ...
    Private Sub Button3_Click_2(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        strPathName = strcProgramName & " " & strcFilePath & " " & "-r -g" & " " & titleid & "-" & dlUpVer & "-" & ticketid & " " & dlcid & "-" & dlDlcUpVer
        dblProgTaskID = Shell(strPathName, vbMaximizedFocus)
        MsgBox(strPathName, MsgBoxStyle.Information)
    End Sub

    Private Sub ComboBox2_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox2.SelectedIndexChanged
        dlDlcUpVer = ComboBox2.SelectedItem.ToString()
    End Sub
End Class
